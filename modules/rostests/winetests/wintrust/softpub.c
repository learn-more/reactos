 ...
 */
static const BYTE SelfSignedExe32[] =
{
...
static const BYTE SelfSignedExe64[] =
{
    0x4D,0x5A,0x90,0x00,0x03,0x00,0x00,0x00,0x04,0x00,0x00,0x00,0xFF,0xFF,0x00,0x00,0xB8,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    0x40,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x80,0x00,0x00,0x00,0x0E,0x1F,0xBA,0x0E,0x00,0xB4,0x09,0xCD,
...
/* Signed catalog file, original catalog for reference:
    30 82 01 A0 06 09 2A 86 48 86 F7 0D 01 07 02 A0 82 01 91 30 82 01 8D 02 01 01 31 00 30 82 01 82
    06 09 2B 06 01 04 01 82 37 0A 01 A0 82 01 73 30 82 01 6F 30 0C 06 0A 2B 06 01 04 01 82 37 0C 01
    01 04 10 FF 63 4D E0 DD 00 80 48 B6 33 5E B6 28 A5 79 8E 17 0D 31 36 30 36 30 34 31 35 34 32 33
    32 5A 30 0E 06 0A 2B 06 01 04 01 82 37 0C 01 02 05 00 30 81 C1 30 81 BE 04 0E 68 00 61 00 73 00
    68 00 6D 00 65 00 00 00 31 81 AB 30 45 06 0A 2B 06 01 04 01 82 37 02 01 04 31 37 30 35 30 10 06
    0A 2B 06 01 04 01 82 37 02 01 19 A2 02 80 00 30 21 30 09 06 05 2B 0E 03 02 1A 05 00 04 14 ED D6
    9C 9C B2 FC AA 03 E8 D3 20 F6 AB 28 C3 FF BD 07 36 F5 30 62 06 0A 2B 06 01 04 01 82 37 0C 02 02
    31 54 30 52 1E 4C 00 7B 00 44 00 45 00 33 00 35 00 31 00 41 00 34 00 32 00 2D 00 38 00 45 00 35
    00 39 00 2D 00 31 00 31 00 44 00 30 00 2D 00 38 00 43 00 34 00 37 00 2D 00 30 00 30 00 43 00 30
    00 34 00 46 00 43 00 32 00 39 00 35 00 45 00 45 00 7D 02 02 02 00 A0 6A 30 68 30 32 06 0A 2B 06
    01 04 01 82 37 0C 02 01 04 24 30 22 1E 0A 00 61 00 74 00 74 00 72 00 32 02 04 10 01 00 01 04 0E
    76 00 61 00 6C 00 75 00 65 00 32 00 00 00 30 32 06 0A 2B 06 01 04 01 82 37 0C 02 01 04 24 30 22
    1E 0A 00 61 00 74 00 74 00 72 00 31 02 04 10 01 00 01 04 0E 76 00 61 00 6C 00 75 00 65 00 31 00
    00 00 31 00
*/
static const BYTE SignedCatFile[1685] = {
    ,
    ...
    
};

/* Signed CAB file from crypt32 test sip.c, original CAB for reference:
    4D 53 43 46 00 00 00 00 50 00 00 00 00 00 00 00
    2C 00 00 00 00 00 00 00 03 01 01 00 01 00 00 00
    EF BE FF FF 42 00 00 00 01 00 00 00 06 00 00 00
    00 00 00 00 00 00 F7 38 4B AC 00 00 61 2E 74 78
    74 00 6D 5A 72 78 06 00 06 00 61 2E 74 78 74 0A
*/
static const BYTE SignedCabFile[1536] = {
    
};

/* Signed msi file from msi_winetest db (test_msiinsert)
*/

#define ZEROES_12  0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00
#define ZEROES_60  ZEROES_12,ZEROES_12,ZEROES_12,ZEROES_12,ZEROES_12
#define PADDING_12  0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF
#define PADDING_60  PADDING_12,PADDING_12,PADDING_12,PADDING_12,PADDING_12

static const BYTE SignedMsiFile[20480] = {
    0xD0,0xCF,0x11,0xE0,0xA1,0xB1,0x1A,0xE1,0x00,0x00,0x00,0x00,ZEROES_12,
    0x3E,0x00,0x04,0x00,0xFE,0xFF,0x0C,0x00,0x06,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x00,0x00,0x00,0
0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,
    PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,
    PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,
    PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,
    PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,
    PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,
    PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,
    PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_60,PADDING_12,
    0xFF,0xFF,0xFF,0xFF,0x70,0x68,0x6F,0x6E,0x65,0x69,0x64,0x6E,0x61,0x6D,0x65,0x6E,0x75,0x6D,0x62,0x65,0x72,0x38,0x36,0x37,
    0x35,0x33,0x30,0x39,0x41,0x62,0x65,0x39,0x36,0x39,0x30,0x35,0x33,0x30,0x35,0x41,0x64,0x61,0x6D,0x00,0x00,0x00,0x00,0x00,
    ZEROES_12,ZEROES_12,ZEROES_12,0x00,0x00,0x00,0x00,0x05,0x00,0x04,0x00,0x02,0x00,0x01,0x00,
    0x04,0x00,0x01,0x00,0x06,0x00,0x01,0x00,0x07,0x00,0x01,0x00,0x03,0x00,0x01,0x00,0x08,0x00,0x01,0x00,0x04,0x00,0x01,0x00,
    ZEROES_12,
    0x05,0x00,0x05,0x00,0x05,0x00,0x01,0x80,0x02,0x80,0x03,0x80,0x06,0x00,0x07,0x00,0x08,0x00,0x02,0xB5,0x20,0x9D,0x20,0x9D,
    ZEROES_12,ZEROES_12,ZEROES_12,0x00,0x00,0x00,0x00,0x05,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    ZEROES_12,ZEROES_12,ZEROES_12,ZEROES_12,
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x80,0x02,0x80,0x0A,0x00,0x0C,0x00,0x09,0x00,0x0B,0x00,0x00,0x00,0x00,0x00,
    ZEROES_12,ZEROES_12,ZEROES_12,ZEROES_12,
    0xF5,0xA3,0xE0,0x71,0x6D,0xB8,0x92,0xA5,0x11,0xD0,0x29,0x13,0xFE,0x00,0x9D,0x81,0xCC,0x9E,0xAD,0xFF,0x00,0x00,0x00,0x00,
    ZEROES_12,ZEROES_12,ZEROES_12,,ZEROES_60,ZEROES_60,ZEROES_60,ZEROES_60,ZEROES_60,
    ZEROES_60,ZEROES_60,ZEROES_60,ZEROES_60,ZEROES_60,ZEROES_60,ZEROES_60,ZEROES_60,ZEROES_60,ZEROES_60,ZEROES_60,
    ZEROES_60,ZEROES_60,ZEROES_60,ZEROES_60,ZEROES_60,ZEROES_60,ZEROES_60,ZEROES_60,ZEROES_60,ZEROES_60,ZEROES_60,
    ZEROES_60,ZEROES_60,ZEROES_60,ZEROES_60,ZEROES_60,ZEROES_60,ZEROES_60,ZEROES_60,ZEROES_60,ZEROES_60,ZEROES_60,
    ZEROES_12,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00
};
...
static void test_wintrust_digest(void)
{
    ...
    tests[] =
    {
        /* 32-bit EXE tests */
        {
            {{ SelfSignedExe32, sizeof(SelfSignedExe32) }},
        ...
        {
            {{ Dummy, sizeof(Dummy) },
             { SelfSignedExe32 + sizeof(Dummy), sizeof(SelfSignedExe32) - sizeof(Dummy) }},
            { TRUST_E_SUBJECT_FORM_UNKNOWN, FALSE }, { TRUST_E_NOSIGNATURE, TRUE }
        },
        {
            {{ SelfSignedExe32, 19 },
             { Dummy, sizeof(Dummy) },
             { SelfSignedExe32 + 19 + sizeof(Dummy), sizeof(SelfSignedExe32) - 19 - sizeof(Dummy) }},
            { TRUST_E_BAD_DIGEST, FALSE }, { TRUST_E_NOSIGNATURE, TRUE }
        },
        {
            {{ SelfSignedExe32, sizeof(IMAGE_DOS_HEADER) }},
            { TRUST_E_SUBJECT_FORM_UNKNOWN, TRUE }, { TRUST_E_NOSIGNATURE, FALSE }
        },
        {
            {{ SelfSignedExe32, sizeof(IMAGE_DOS_HEADER) + sizeof(IMAGE_NT_HEADERS32) * 2 }},
            { TRUST_E_NOSIGNATURE, FALSE }, { TRUST_E_NOSIGNATURE, FALSE }
        },

        /* 64-bit EXE tests */
        {
            {{ SelfSignedExe64, sizeof(SelfSignedExe64) }},
            { CERT_E_CHAINING, TRUE }, { S_OK, FALSE }
        },
        {
            {{ SelfSignedExe64, sizeof(SelfSignedExe64) },
        ...
        {
            {{ Dummy, sizeof(Dummy) },
             { SelfSignedExe64 + sizeof(Dummy), sizeof(SelfSignedExe64) - sizeof(Dummy) }},
            { TRUST_E_SUBJECT_FORM_UNKNOWN, FALSE }, { TRUST_E_NOSIGNATURE, TRUE }
        },
        {
            {{ SelfSignedExe64, 19 },
             { Dummy, sizeof(Dummy) },
             { SelfSignedExe64 + 19 + sizeof(Dummy), sizeof(SelfSignedExe64) - 19 - sizeof(Dummy) }},
            { TRUST_E_BAD_DIGEST, FALSE }, { TRUST_E_NOSIGNATURE, TRUE }
        },
        {
            {{ SelfSignedExe64, sizeof(IMAGE_DOS_HEADER) }},
            { TRUST_E_SUBJECT_FORM_UNKNOWN, TRUE }, { TRUST_E_NOSIGNATURE, FALSE }
        },
        {
            {{ SelfSignedExe64, sizeof(IMAGE_DOS_HEADER) + sizeof(IMAGE_NT_HEADERS64) * 2 }},
            { TRUST_E_NOSIGNATURE, FALSE }, { TRUST_E_NOSIGNATURE, FALSE }
        },
        /* Signed .cat file tests */
        {
            {{ SignedCatFile, sizeof(SignedCatFile) }},
            { CERT_E_CHAINING, TRUE }, { TRUST_E_NOSIGNATURE, TRUE }
        },
        {
            {{ SignedCatFile, sizeof(SignedCatFile) },
            { Dummy, sizeof(Dummy) }},
            { CERT_E_CHAINING, FALSE }, { TRUST_E_NOSIGNATURE, FALSE }
        },
        {
            {{ Dummy, sizeof(Dummy) },
            { SignedCatFile + sizeof(Dummy), sizeof(SignedCatFile) - sizeof(Dummy) }},
            { TRUST_E_SUBJECT_FORM_UNKNOWN, FALSE }, { TRUST_E_NOSIGNATURE, TRUE }
        },
        {
            {{ SignedCatFile, 19 },
            { Dummy, sizeof(Dummy) },
            { SignedCatFile + 19 + sizeof(Dummy), sizeof(SignedCatFile) - 19 - sizeof(Dummy) }},
            { TRUST_E_SUBJECT_FORM_UNKNOWN, FALSE }, { TRUST_E_NOSIGNATURE, TRUE }
        },

        /* Signed .cab file tests */
        {
            {{ SignedCabFile, sizeof(SignedCabFile) }},
            { CERT_E_CHAINING, TRUE }, { S_OK, TRUE }
        },
        {
            {{ SignedCabFile, sizeof(SignedCabFile) },
            { Dummy, sizeof(Dummy) }},
            { TRUST_E_BAD_DIGEST, FALSE }, { TRUST_E_NOSIGNATURE, FALSE }
        },
        {
            {{ Dummy, sizeof(Dummy) },
            { SignedCabFile + sizeof(Dummy), sizeof(SignedCabFile) - sizeof(Dummy) }},
            { TRUST_E_SUBJECT_FORM_UNKNOWN, FALSE }, { TRUST_E_NOSIGNATURE, TRUE }
        },
        {
            {{ SignedCabFile, 19 },
            { Dummy, sizeof(Dummy) },
            { SignedCabFile + 19 + sizeof(Dummy), sizeof(SignedCabFile) - 19 - sizeof(Dummy) }},
            { TRUST_E_BAD_DIGEST, FALSE }, { TRUST_E_NOSIGNATURE, TRUE }
        },

        /* Signed .msi file tests */
        {
            {{ SignedMsiFile, sizeof(SignedMsiFile) }},
            { CERT_E_CHAINING, TRUE }, { S_OK, TRUE }
        },
        {
            {{ SignedMsiFile, sizeof(SignedMsiFile) },
        ...
        {
            {{ Dummy, sizeof(Dummy) },
            { SignedMsiFile + sizeof(Dummy), sizeof(SignedMsiFile) - sizeof(Dummy) }},
            { TRUST_E_SUBJECT_FORM_UNKNOWN, FALSE }, { TRUST_E_NOSIGNATURE, TRUE }
        },
        {
            {{ SignedMsiFile, 19 },
            { Dummy, sizeof(Dummy) },
            { SignedMsiFile + 19 + sizeof(Dummy), sizeof(SignedMsiFile) - 19 - sizeof(Dummy) }},
            { CERT_E_CHAINING, FALSE }, { S_OK, TRUE }
        },
